...
const JobByIdPage = () => {
    ...
    const [processing, setProcessing] = useState(false) // Prevents multiple requests
    const { id } = useParams()
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white p-6">
            <div className="max-w-4xl mx-auto bg-gray-800 p-8 rounded-lg shadow-lg border border-gray-700">
                ...
                {/* Job Details: Experience, Location, Job Type */}
                ...
                <div className="mt-6">
                    ...
                    <p className="text-gray-400">As a <b>{job.title?.split(' (')[0] || job.title}</b>, you will:</p>
                ...
                {/* Qualifications */}
                <div className="mt-6">
                    <h2 className="text-xl font-semibold text-gray-300 mb-2">Qualifications</h2>
                    <ul className="text-gray-400 space-y-2">

            ...
            {applications.length > 0 ? (
                <div className="w-full space-y-4 sm:space-y-6">
                    {applications.map((application) => (
                        ...
                        >
                            <h2 className="text-lg sm:text-2xl font-semibold text-white">{application.jobId.title}</h2>
                ...
                <p className="text-center text-gray-400 text-sm sm:text-lg">No applications found.</p>
            )}
        </div>
    );
};
